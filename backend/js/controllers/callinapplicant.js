...
/* Controllers */
// callin applicant list controller
app.controller('CallinApplicantController', function($scope, $modal, $stateParams, $filter, MessageWindow, Adviser, CallinCustomer) {
    var vm = this;
    ...
    $scope.getPagedDataAsync = function () {
        setTimeout(function () {
            ...
            CallinCustomer.applicants($scope.pagingOptions.currentPage, $scope.pagingOptions.pageSize, ft, start_date, end_date, is_assign).then(
                function (response) {

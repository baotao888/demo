...
angular.module('app')
    ...
    .constant('JQ_CONFIG', {
        ...
        nestable: ['vendor/jquery/nestable/jquery.nestable.js', 'vendor/jquery/nestable/nestable.css'],
        filestyle: ['vendor/jquery/file/bootstrap-filestyle.min.js'],
        slider: ['vendor/jquery/slider/bootstrap-slider.js', 'vendor/jquery/slider/slider.css'],
        chosen: ['vendor/jquery/chosen/chosen.jquery.min.js', 'vendor/jquery/chosen/chosen.css'],
        TouchSpin: ['vendor/jquery/spinner/jquery.bootstrap-touchspin.min.js', 'vendor/jquery/spinner/jquery.bootstrap-touchspin.css'],
        wysiwyg: ['vendor/jquery/wysiwyg/bootstrap-wysiwyg.js', 'vendor/jquery/wysiwyg/jquery.hotkeys.js'],
        dataTable:[
        ...
        $ocLazyLoadProvider.config({
            ...
            modules: [
                ...
                },
                {
                    name: 'ng.ueditor',
                    files: [
                        'vendor/modules/ueditor/ueditor.config.js',
                        'vendor/modules/ueditor/ueditor.all.min.js',
                        'vendor/modules/ueditor/angular-ueditor.js',
                        'vendor/modules/ueditor/lang/zh-cn/zh-cn.js'
                    ]
                }
            ]
        });

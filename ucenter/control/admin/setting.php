...
class control extends adminbase {
	...
	function onregister() {
		$updated = false;
		if($this->submitcheck()) {
			$this->set_setting('emptye', getgpc('emptye', 'P'));
		...
		$emptyechecked = array($settings['emptye'] => 'checked="checked"');
		$this->view->assign('emptye', $emptyechecked);

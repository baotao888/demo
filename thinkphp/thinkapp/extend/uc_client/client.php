...
define('UC_AVATAR_PATH', UC_DATAURL.'/avatar');
...
function uc_get_user($username, $isuid=0, $ismobile=0) {
	$return = call_user_func(UC_API_FUNC, 'user', 'get_user', array('username'=>$username, 'isuid'=>$isuid, 'ismobile'=>$ismobile));
	return UC_CONNECT == 'mysql' ? $return : uc_unserialize($return);
}

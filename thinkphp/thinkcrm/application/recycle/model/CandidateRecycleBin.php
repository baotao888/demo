<?php
namespace app\recycle\model;

use think\Model;

class CandidateRecycleBin extends Model
{
	/**
	 * 客户信息
	 */
	...
	{
		return $this->hasOne('app\customer\model\CustomerPool', 'id', 'cp_id')->field('real_name, phone, gender, idcard');
	}
